...
namespace Checkout
{
    ...
    public sealed class AppSettings
    {
        ...
        private static string _drinkServiceUri ;
        ...
        public static string DrinkServiceUri
        {
            get { return _drinkServiceUri ?? (_drinkServiceUri = ReadConfig("Checkout.DrinkServiceUri", true)); }
            set { _drinkServiceUri = value; }
        }
