namespace Checkout
{
    public class ApiUrls
    {
        ...
        public static string Drinks
            => _drinksApiUri ?? (_drinksApiUri = string.Concat(AppSettings.DrinkServiceUri, "/orders/"));

        public static string Drink
            => _drinkApiUri ?? (_drinkApiUri = string.Concat(AppSettings.DrinkServiceUri, "/orders/{0}"));
